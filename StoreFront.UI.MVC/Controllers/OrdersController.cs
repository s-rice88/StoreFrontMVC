...
namespace StoreFront.UI.MVC.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public OrdersController(EducatedMoneyContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("OrderId,UserId,PurchaseDate,PurchasePrice,ProductId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,UserId,PurchaseDate,PurchasePrice,ProductId")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EducatedMoneyContext.Orders'  is null.");
            }
            var order = await _context.Orders.FindAsync(id);
            if (order != null)
            {
